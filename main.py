...
data = r'D:\cement_strenght3\Concrete-Compressive-Strength-Prediction\dataset\concrete_data.csv'
...
joblib.dump(xgbr_model_2, 'D:\cement_strenght3\Concrete-Compressive-Strength-Prediction\models\XGBoost_Regressor_model.json')
